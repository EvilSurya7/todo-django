    ...
    if request.method == 'GET':
        ...
        if request.POST['password1'] == request.POST['password2']:
            try:
                ...
                return render(request, 'todoapp/signupuser.html', {'form':UserCreationForm(),'error':'Username is already taken.Please choose another username'})
        else:
            return render(request, 'todoapp/signupuser.html', {'form':UserCreationForm(),'error':'password didnt match'})
...
def viewtodo(request, todo_pk):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todoapp/viewtodo.html', {'form':TodoForm(), 'error':'Bad Information'})
...
def createtodo(request):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todoapp/createtodo.html', {'form':TodoForm(), 'error':'Data is incorrect'})
